...
import { FaRupeeSign, FaCalendarAlt, FaChartLine } from "react-icons/fa";
...
const MyEarnings = () => {
    ...
    const filters = ["Today", "Yesterday", "Weekly", "Monthly", "View All"];

    // Capitalize the title based on selected filter
    const getTitle = () => {
        return activeFilter === "View All" ? "Recent Orders" : activeFilter;
    };
